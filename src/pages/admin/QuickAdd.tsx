  ...
  women: [
    {
      ...
      brand: 'Zara',
      stock: 45,
      description: 'Beautiful floral summer dress perfect for warm days. Made from lightweight cotton.',
      isNew: true,
      isTrending: true,
    },
    {
...
export const QuickAddSamples: React.FC = () => {
  const handleQuickAdd = async () => {
    ...
    // Get all products from all genders
    const allProducts = [
    ...
    if (errorCount === 0) {
      ...
      toast.warning(`Added ${addedCount} products, ${errorCount} failed. Check console for details.`);
    }
  };
  ...
  return (
    <button
      ...
      className="bg-gradient-to-r from-green-500 to-teal-500 text-white px-4 py-2 rounded-lg hover:from-green-600 hover:to-teal-600 transition shadow-md font-medium flex items-center gap-2"
    >
